...
\item We provide detailed correspondence theorems showing how bilateral weighted completions relate to existing frameworks including Schoots's categorical extensions \cite{schoots2015generalising}, Pratt's communes \cite{pratt2010communes}, and Garner's cylinder systems \cite{garner2018cylinder}. These correspondences demonstrate that our framework encompasses rather than competes with existing approaches.
\end{enumerate}
...
\addlinespace
Garner's cylinder systems \cite{garner2018cylinder} & Trivial weights $Q = 1$ & Orthogonality $\Leftrightarrow$ Bilateral denseness \\
\addlinespace
